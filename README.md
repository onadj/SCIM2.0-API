...
A file named workplace_employees_info_[yyyy-mm-dd-HH_mm].xlsx will be created in the same folder where your run the script. It will populate some columns with values from the SCIM API calls:
